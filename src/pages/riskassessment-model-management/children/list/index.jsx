...
const StoreManagementList = (props) => {
      ...
      <div className='table-con'>
        <div className='table-header'>
          <Search
            ...
            style={{ width: 350 }}
          />
          <Button className='button' type='primary' onClick={() => router.push({pathname: '/riskassessment-model-management/detail', state: {id: ''}})}>添加模型</Button>
        </div>
        <ProjectTable
          size={params.size}
          page={params.page}
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  fetchList: (params = {}) => dispatch({ type: `${TABLE_NAME_SPACE}/fetchModelsList`, payload: params }),
  // fetchConfigStoreList: () => dispatch({ type: `${TABLE_NAME_SPACE}/fetchConfigStoreList`})
})
export default connect(mapState, mapDispatchToProps)(StoreManagementList)